<?php require_once '../app/settings/params/connect' ;?>
<!doctype html>
<html lang=fr>

<head>
    <meta charset=UTF-8>
    <title>Institut supérieur de techniques appliquées | Verification des résultats en ligne | Système de numérisation
        de l'enseignement</title>
    <meta name=description
        content="ISTA-Kinshasa - Consulter les résultats des mi-session, session et deuxième session (session de rattrapage) en ligne directement sur la plateforme de l'Institut Supérieur des Techniques Appliquées (ISTA en sigle)">
    <meta name=keywords
        content="Check resultat, resultat en ligne, institut, technique, application, université, kinshasa, industrie, informatique, aviation, mecanique, telecommunication, electronique, electricite, maintenance materiaux medicales, preparatoire, apprentissage, technologie, universtic">
                    ...
                    <div class=col-lg-6>
                        <div class="ft-thx-banner-text headline pera-content">
                            ...
                            <p>Bienvenue dans le système de numérisation de l'éducation conçu par <a class=link-warning
                                    href=http://www.viraza.net target=_blank rel="noopener noreferrer">viraza</a> dans
                                le
                                    ...
                                    <div class=row>
                                        ...
                                        <div class=col-md-12>
                                            ...
                                            <div class=wc-input>
                                                ...
                                                <div class="wc-text-input position-relative">
                                                    <input id=check_code name=check[code] placeholder=KEY-AD8S-9J8S-ER82>
                                                </div>
                                            </div>
                                        ...
                                        <button class=text-uppercase type=submit>Check Code</button>
                                    </div>
                                </form>
                            </div>
                        </div>
