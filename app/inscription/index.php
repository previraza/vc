    ...
    <div class="container d-block">
        <div class="ft-blog-top-content d-flex justify-content-between align-items-end flex-wrap">
            <div class="ft-section-title pera-content w-100 mw-100">
                ...
                <span class="sub-title">Session 2024-2025</span>
            </div>
        </div>
                    ...
                    <div class="wizard-form bg-transparent">
                        <form class="form-register" id="form-register" action="#" method="post">
                            ...
                            <section>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="list">
                                        ...
                                        <input type="radio" name="cycle" value="c1" id="c1">
                                        <label for="c1">
                                            <div class="title">
                                            Premier Cycle
                                            </div>
                                        ...
                                        <div class="form-element">
                                        <input type="radio" name="cycle" value="c3" id="c3">
                                        <label for="c3">
                                            <div class="title">
                                            Troisième cycle
                                            </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="list">
                                        ...
                                        <div class="form-element" style="display: none;">
                                        <input type="radio" name=orientation class="orientation c1" value="c1-btp" id="c1-btp">
                                        <label for="c1-btp">
                                            <div class="title">
                                            <h3>BTP</h3>
                                            </div>
                                        ...
                                        <div class="form-element" style="display: none;">
                                        <input type="radio" name=orientation class="orientation c1" value="c1-gtp" id="c1-gtp">
                                        <label for="c1-gtp">
                                            <div class="title">
                                            <h3>GTP</h3>
                                            </div>
                                        ...
                                        <div class="form-element" style="display: none;">
                                        <input type="radio" name=orientation class="orientation c2" value="c2-l1" id="c2-l1">
                                        <label for="c2-l1">
                                            <div class="title">
                                        ...
                                        <div class="form-element" style="display: none;">
                                        <input type="radio" name=orientation class="orientation c2" value="c2-l2" id="c2-l2">
                                        <label for="c2-l2">
                                            <div class="title">
                                        ...
                                        <div class="form-element" style="display: none;">
                                        <input type="radio" name=orientation class="orientation c3" value="c3-m1" id="c3-m1">
                                        <label for="c3-m1">
                                            <div class="title">
                                            <h6>Master 1</h6>
                                            </div>
                            ...
                            <h2>
                                ...
                                <span class="step-text">Condition Générale</span>
                            </h2>
                            <section>
                                <div class="inner inner-0">
                                    <div class="form-heading">
                                    <h3 class=pb-3>Reglementation</h3>
                                    <span>3/10</span>
                                    </div>
                                    <div class="form-row">
                                    <p class="description">
                                    Inscription au programme de formation de l'Institut supérieur de techniques appliquées (ISTA-KINSHASA)
                                    </p>
                                    <div class="description">
                                        Ne peut s'inscrire que :
                                        <ol class="m-0 ml--30">
                                        <li>les detenteurs d'un diplome d'Etat (Baccalaureat)
                                            (sans prise en compte du niveau actuel) ;
                                        </li>
                                        <li>les non diplome titulaires du DAEU (diplôme d'accès
                                            aux études universitaires, pour les
                                            etranger) ;</li>
                                        </ol>
                                    </div>
                                    <p class="description">
                                        L'etudiant inscrit s'engage a respecter les conditions et
                                        reglement d'ordre interieur de
                                        l'etablissement.
                                    </p>
                                    </div>
                                    <div class="form-heading">
                                    ...
                                    <div class="description">
                                        ...
                                        <ul class="m-0 ml--30">
                                        <li>Formulaire d'iscription</li> 
                                           <li>4 photos passeports récentes;</li>
                                            <li>Bulletin de 4ème, 5ème et 6ème des humanités (Légalisés);</li>
                                            <li>Diplôme d'État (Baccalauréat) ou l'équivalent (Légalisé);</li>
                                            <li>Attestation de Naissance;</li>
                                            <li>Attestation de Bonne vie et Moeurs;</li>
                                            <li>Attestation de Nationalité (carte d'électeur ou passeport);</li>
                                            <li>Certificat médical (Voir Centre Médical de l'ISTA);</li>
                                            <li>Reçu du paiement de Frais d'inscription.</li>
                                        </ul>
                                    </div>
                                    <p class="description">
                                        <b>N.B : </b> Ce bulletin est une demande d'inscription. L'Admission sera prononcée apres examen de son contenu.
                                    </p>
                                    <p class="description">
                                        Les eleves nouvellements diplomés devront annexer une photocopie de l'attestation de reussite tenant lieu du diplome d'etat delivré par l'Inspection Generale de l'E.P.S.T
                                    </p>
                                    </div>
                                    <div class="form-heading">
                                    <h3 class=pb-3>Frais d'Inscription</h3>
                                    <span>5/10</span>
                                    </div>
                                    <div class="form-row">
                                    <div class="description">
                                        Pour s'inscrire a l'Institut National du Bâtiment et des
                                        Travaux Publics - ISTA en sigle, vous
                                        devez vous acquiter des frais suivants :
                                    </div>
                                    <table class="table-pricing table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                            <td>3</td>
                                            <td>Certificat d.aptitude physique</td>
                                            <td>10$</td>
                                            </tr>
                                            <tr>
                                            <td>4</td>
                                            <td>Guide de redaction scientifique</td>
                                            <td>10$</td>
                                            </tr>
                                            <tr>
                                            <td>5</td>
                                            <td>Chasuble et casque de constructeur</td>
                                            <td>10$</td>
                                            </tr>
                                            <tr>
                                            <td>5</td>
                                            <td>Reglement d'ordre interieur</td>
                                            <td>5$</td>
                                            </tr>
                                            <tr>
                                            <td>5</td>
                                            ...
                                            <tr>
                                            <td>5</td>
                                            <td>Authentification diplome de base</td>
                                            <td>1$</td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                            <th colspan="2">Total a payer a la caisse</th>
                                            <th>61 $</th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                                <div class="form-row justify-content-center hide-printer">
                                ...
                                <div class="inner inner-2">
                                    <div id="content-form-wrapper">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                                <label>Numero de tellephone</label>
                                            ...
                                            <div class="form-heading col-12">
                                                <h3 class=pb-3>Etudes Secondaires Faites</h3>
                                                <span>7/10</span>
                                            </div>

                                            <div class="col-xl-6 col-lg-6 col-12 form-group">
                                                <label>Nom de l'ecole secondaire</label>
                                                <input type="text" placeholder="" ng-model=ecole name=register[ecole]
                                                class="form-control" required>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-12 form-group">
                                                <label>Addresse de l'ecole secondaire</label>
                                                <input type="text" placeholder=""
                                            ...
                                            <div class="col-xl-4 col-lg-6 col-12 form-group">
                                                <label>Section suivi aux humanites</label>
                                                <input type="text" placeholder="" ng-model=section name=register[section]
                                                class="form-control" required>
                                            </div>
                                            <div class="col-xl-4 col-lg-6 col-12 form-group">
                                                <label>Nom du centre d'examination</label>
                                                <input type="text" placeholder=""
                                                ng-model=centre_exetat name=register[centre_exetat]
                                                class="form-control" required>
                                            </div>
                                            <div class="col-xl-4 col-lg-6 col-12 form-group">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-12 form-group">
                                                <label>Lieu d'obtention du diplome</label>
                                                <input type="text" placeholder=""
                                                ng-model=ld_exetat name=register[ld_exetat]
                                                class="form-control" required>
                                            </div>
                                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <div class="form-heading col-12">
                                                <h3 class=pb-3>Occupations apres ses humanites</h3>
                                                <span>8/10</span>
                                            </div>
                                            ...
                                            <div class="col-12 form-group">
                                                <label>Etudes post-secondaires</label>
                            ...
                            <section>
                                    ...
                                    <div class="form-holder form-holder-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="contact-information col-xl-12 col-lg-6 col-12 mt-3">
                                                <h3>Etudes secondaires faites</h3>
                                                <table class=w-100>
                                                    <tbody>
                                                        <tr>
                                ...
                                <div class="form-row">
                                    <div class="form-holder form-holder-2">
                                    <label for="room" class="special-label-1">Numero de facturation du borderaux d'inscription</label>
                                    <input type="text" placeholder="#0xx0000000000000000" ng-model=numero_bordereau name=register[numero_bordereau] class="form-control" value=0>
