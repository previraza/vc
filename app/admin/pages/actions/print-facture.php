...
$fc = $db_poo->query("SELECT payments.*, register.telephone, register.sexe, CONCAT(agents.firstname, ' ', agents.lastname) AS agent, CONCAT(register.nom, ' ', register.postnom) AS std 
        FROM payments LEFT JOIN agents ON payments.user_id = agents.user_id LEFT JOIN register ON register.id = payments.student  WHERE payments.id = " . (isset($_GET['id']) ? $_GET['id'] : 0)) or die($db_poo->error);
$fac = $fc->fetch_object();
if (!empty($fac)) {
    $f = $fac;
...
?>
    ...
    <head>
        ...
        <meta name="description" content="Institut Supérieur de Techniques Appliquées | Kinshasa">
                        ...
                        <div class="download-inner" id="download_section">
                            <header class="as-header header-layout1">
                                <div class="row
                                    ...
                                    <div class="col-auto">
                                        <div class="header-logo"><a href="index.html"><img style="max-height:50px;" src="/public/assets/imgs/home26.png" alt="Invce"></a></div>
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-between">
                                <div class="col-auto">
                                    <div class="booking-info">
                                        <p><b>Institut supérieur de techniques appliquées - ISTA Kinshasa
                                            </b></p>
                            ...
                            <div class="row gx-0">
                                <div class="col-6">
                                    <div class="address-box address-left"><b>Vos
                                            Informations :</b>
                                        <address><?= $f->std ? $f->std : $f->student_name ?><br>Phone: <?= $f->telephone ?><br>Sexe:
                                            <?= ["_" => "", "A" => "Autre", "F" => "Féminin", "M" => "Masculin"][$f->sexe ? $f->sexe : '_'] ?><br></address>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="address-box
                                        address-right"><b>Details Agences:</b>
                                        <address>Vira-Bank<br>Guichet No. 2<br>Kinshasa-Barumbu,
                                            R.D.Congo.</address>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-between">
                                <div class="col-auto">
                                    <div class="invoice-left"><b>Please
                                            Note:</b>
                            ...
                            <p class="company-address"><b>Invce Inc:</b><br>3930, Av. Aérodrome, Ndolo, Kinshasa-Barumbu, République Démocratique du Congo</p>
                            <p class="invoice-note mt-3 text-center"><svg width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3.22969
