...
<body>
    <div class="invoice-container-wrap">
        <div class="invoice-container my-0" style="background-color: #fff;">
            <?php $rqt = $db_poo->query("SELECT * FROM payments WHERE user_id = -5000 AND type = 'INSCR'") or die($db_poo->error); 
                        ...
                        <div class="row justify-content-between">
                            <div class="col-auto">
                                <div class="booking-info mb-1">
                                    ...
                                    <p class="mb-0"><b>Formulaire d'inscription en ligne : </b>https://www.ista.ac.cd/inscription</p>
                                </div>
                            </div>
                        </div>
