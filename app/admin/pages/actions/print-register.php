<?php 
   ...
   $fc = $db_poo->query("SELECT * FROM students_ WHERE id = ".(isset($_GET['id'])&&is_numeric($_GET['id'])?$_GET['id']:0)) or die($db_poo->error);
   $fac = $fc->fetch_object();
   ...
   $univ_data = (object) [
      'short_name' => 'ISTA',
      'sector' => 'KINSHASA',
      'univ' => 'Institut Supérieur de Techniques Appliquées',
      'address' => '3930 Aérodrome, Ndolo, Kinshasa-Barumbu, <br />Congo-Kinshasa',
      'domaine' => 'ista.ac.cd'
   ]
?>
<!doctype html>
<html class="no-js" lang="zxx">
   <head>
      ...
      <title>FORMULAIRE D'INSCRIPTION - <?= $f->id ?> (<?="$f->firstname $f->lastname $f->homename"?>) - <?= $univ_data->short_name ?> <?= $univ_data->sector ?></title>
      <meta name="author" content="Mci Mangala">
      <meta name="description" content="Formulaire d'Inscription de <?= $univ_data->univ ?>">
      <meta name="keywords" content="<?= $univ_data->univ ?>">
               ...
               <div class="as-invoice invoice_style15">
                  <div class="download-inner" id="download_section">
                        ...
                        <div class="row align-items-center justify-content-between">
                           <div class="col-auto">
                              <div class="header-logo">
                                 <a href="/">
                                    <img src="/public/assets/img/logo/logo-white.webp" alt="Profil <?= $univ_data->short_name ?> student" width="150px" height="150px">
                                    <span class=text-left><b>Numero d'inscription : </b>#<?= $f->id ?></span>
                                    <span class=text-left><b>Date d'Inscription: </b><?= $f->joining_date ?></span>
                                 </a>
                              </div>
                           </div>
                           <div class="col-auto">
                              <img src="/<?= $f->profile ?>" alt="Profil <?= $univ_data->short_name ?> student" width="180px" height="90px">
                           </div>
                        </div>
                     ...
                     <div class="row justify-content-between my-4">
                        <div class="col">
                           <b><?= $univ_data->short_name ?> - <?= strtoupper($univ_data->sector) ?> :</b>
                           <address>
                              <?= $univ_data->univ ?> <br />
                              <?=$univ_data->address?> <hr />
                              <b>FORMULAIRE D'INSCRIPTION</b>
                           </address>
                        </div>
                        <div class="col-auto">
                           <div class="invoice-right">
                              <b><?="$f->firstname $f->lastname $f->homename"?></b>
                              <address>
                                 <?=$f->address?>, <br><?=$f->phone?>,<br><?=$f->email?>
                                 <hr /><?=str_replace(' ', '', strtolower("$f->firstname$f->lastname$f->homename$f->id"))?>@<?= $univ_data->domaine ?>
                                 <br /><b>matricule</b> : 23/<?=str_pad($f->id, 8, 0, STR_PAD_LEFT)?>
                              </address>
                           </div>
                        </div>
                     </div>
                     ...
                     <table class="invoice-table table-style8">
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><?=$f->homename?></td>
                              <th>Genre:</th>
                              <td><?=['M'=>"Masculin", 'F'=>"Feminin", 'A'=>"Autre"][$f->gender]??""?></td>
                           </tr>
                           <tr>
                              <th>Etat-civil :</th>
                              <td><?=['C'=>"Celibataire", 'M'=>"Marie(e)", 'D'=>"Divorse(e)", 'A'=>"Autre"][$f->marital_status]?> </td>
                              <th>La religion :</th>
                              <td><?=['C'=>"Chretien", 'H'=>"Hislamiste", 'A'=>"Autre"][$f->religion]??""?> </td>
                           </tr>
                           <tr>
                              <th>Lieu de naissance :</th>
                              <td><?=$f->place_of_birth?></td>
                     ...
                     <table class="invoice-table table-style8">
                        <tbody>
                           ...
                           <tr>
                              <th colspan="3">Email obtenu après validation de l demande</th>
                              <td>etudiant<?=$f->id?>@<?= $univ_data->domaine ?></td>
                           </tr>
                        </tbody>
                     </table>
                     ...
                     <table class="invoice-table table-style8">
                        <tbody>
                           <tr>
                              <th>Ecole :</th>
                              <td><?=$f->secondary_school_name?></td>
                              <th>Section :</th>
                              <td><?=$f->humanities_monitoring_section?></td>
                           </tr>
                           <tr>
                              <th>Addresse de l'ecole:</th>
                              <td><?=$f->secondary_school_address?></td>
                              <th>Nom du centre d'examination :</th>
                              <td><?=$f->name_of_examination_center?></td>
                           </tr>
                           <tr>
                              <th>Lieu d'obtetion :</th>
                              <td><?=$f->place_of_obtaining_the_diploma?></td>
                              <th>Annee d'obtention :</th>
                              <td><?=$f->year_of_graduation?></td>
                           </tr>
                           <tr>
                              <th>Pourcentage :</th>
                              <td><?=$f->percentage?></td>
                              <th>Numéro du diplôme :</th>
                              <td><?=$f->diploma_number?></td>
                           </tr>
                        </tbody>
                     </table>
                     ...
                     <table class="invoice-table table-style8">
                        <tbody>
                           <tr>
                              ...
                              <td><?=$f->professional_activity?></td>
                           </tr>
                           <tr>
                              <th>Etudes post-secondaire :</th>
                              <td><?=$f->post_secondary_studies?></td>
                           </tr>
                        </tbody>
                     </table>
                     <p class="company-address style2"><b><?= $univ_data->short_name ?> : </b><br><?= $univ_data->address ?></p>
