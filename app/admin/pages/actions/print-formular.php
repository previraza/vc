<?php 
   ...
   $fc = $db_poo->query("SELECT * FROM register WHERE id = ".(is_numeric($_GET['id'])?$_GET['id']:0)) or die($db_poo->error);
   $fac = $fc->fetch_object();
   if (!empty($fac)){ $f = $fac;
      if (isset($_SESSION['USER'])) {
         $user = (object) $_SESSION['USER'];
         $user->data = (object) $_SESSION['PROFILE'];
      }
?>
<!doctype html>
<html class="no-js" lang="zxx" data-formular="<?=$f->id?>">
   <head>
      <meta charset="utf-8">
      <meta http-equiv="x-ua-compatible"
         content="ie=edge">
      <title>FACTURE ISTA KINSHASA - <?= $f->id ?> - <?="$f->nom $f->postnom"?></title>
            ...
            <main>
               <div class="as-invoice invoice_style15">
                  <div class="download-inner" id="download_section">
                        ...
                        <div class="row align-items-center justify-content-between">
                           <div class="col-auto">
                              <div class="header-logo">
                                <a href="/">
                                <img src="/public/assets/img/logo/logo2.webp" alt="Profil-ISTA-student" width="150px" height="150px">
                           ...
                           <div class="col-auto">
                              <img src="<?= $f->profile ?>" alt="Profil-ISTA-student" style="max-width:200px;" width="180px" height="90px" style="width:auto">
                           </div>
                        </div>
                     ...
                     <div class="row justify-content-between my-4">
                        ...
                        <div class="col-auto">
                           <div class="invoice-right">
                              <b><?="$f->nom $f->postnom"?></b>
                              <address><?=$f->adresse?>, <br><?=$f->telephone?><br>info@ISTA.ac.cd</address>
                           </div>
                        </div>
                     </div>
                     <hr class="style1">
                     ...
                     <table class="invoice-table table-style8">
                        <tbody>
                           <tr>
                              <th>Nom :</th>
                              <td data-input="nom"><?=$f->nom?> </td>
                              <th>Postnom :</th>
                              <td data-input="postnom"><?=$f->postnom?></td>
                           </tr>
                           <tr>
                              <th>Prenom :</th>
                              <td data-input="prenom"><?=$f->prenom?></td>
                              <th>Code d'Inscription:</th>
                              <td data-input="numero_bordereau"><?=$f->numero_bordereau?></td>
                           </tr>
                           <tr>
                              <th>Etat-civil :</th>
                              <td data-input="etat_civil"><?=['C'=>"Celibataire", 'M'=>"Marie(e)", 'D'=>"Divorse(e)", 'A'=>"Autre"][$f->etat_civil]??"Undefined"?> </td>
                              <th>Genre:</th>
                              <td data-input="sexe"><?=['M'=>"Masculin", 'F'=>"Feminin", 'A'=>"Autre"][$f->sexe]??"Undefined"?></td>
                           </tr>
                           <tr>
                              <th>Lieu de naissance :</th>
                              <td data-input="lieu_de_naissance"><?=$f->lieu_de_naissance?></td>
                              <th>Date de naissance :</th>
                              <td data-input="date_de_naissance"><?=$f->date_de_naissance?></td>
                           </tr>
                           <tr>
                              <th>Père :</th>
                              <td data-input="pere"><?=$f->pere?></td>
                              <th>Mère :</th>
                              <td data-input="mere"><?=$f->mere?></td>
                           </tr>
                        </tbody>
                     </table>
                     ...
                     <table class="invoice-table table-style8">
                        <tbody>
                           <tr>
                              ...
                              <td data-input="pays" colspan="3"><?=$f->pays?></td>
                           </tr>
                           <tr>
                              <th>Province :</th>
                              <td data-input="province"><?=$f->province?></td>
                              <th>Térritoire :</th>
                              <td data-input="territoire"><?=$f->territoire?></td>
                           </tr>
                           <tr>
                              <th>District :</th>
                              <td data-input="district"><?=$f->district?></td>
                              <th>Secteur :</th>
                              <td data-input="secteur"><?=$f->secteur?></td>
                           </tr>
                        </tbody>
                     </table>
                     ...
                     <table class="invoice-table table-style8">
                        <tbody>
                           <tr>
                              ...
                              <td colspan="3" data-input="adresse"><?=$f->adresse?></td>
                           </tr>
                           <tr>
                              <th>Téléphone :</th>
                              <td colspan="3" data-input="telephone"><?=$f->telephone?></td>
                           </tr>
                        </tbody>
                     </table>
                     ...
                     <table class="invoice-table table-style8">
                        <tbody>
                           <tr>
                              <th>Ecole :</th>
                              <td data-input="ecole"><?=$f->ecole?></td>
                              <th>Section :</th>
                              <td data-input="section"><?=$f->section?></td>
                           </tr>
                           <tr>
                              <th>Addresse de l'ecole:</th>
                              <td data-input="ecole_addresse"><?=$f->ecole_addresse?></td>
                              <th>Nom du centre d'examination :</th>
                              <td data-input="centre_exetat"><?=$f->centre_exetat?></td>
                           </tr>
                           <tr>
                              <th>Lieu d'obtetion :</th>
                              <td data-input="ld_exetat"><?=$f->ld_exetat?></td>
                              <th>Annee d'obtention :</th>
                              <td data-input="year_exetat"><?=$f->year_exetat?></td>
                           </tr>
                           <tr>
                              <th>Pourcentage :</th>
                              <td data-input="pourcentage"><?=$f->pourcentage?></td>
                              <th>Numéro du diplôme :</th>
                              <td data-input="numero_diplome"><?=$f->numero_diplome?></td>
                           </tr>
                        </tbody>
                     </table>
                     ...
                     <table class="invoice-table table-style8">
                        <tbody>
                           <tr>
                              ...
                              <td data-input="activite_professionnelle"><?=$f->activite_professionnelle?></td>
                           </tr>
                           <tr>
                              <th>Etudes post-secondaire :</th>
                              <td data-input="autres_formations"><?=$f->autres_formations?></td>
                           </tr>
                        </tbody>
                     </table>
                  ...
                  <div class="invoice-buttons">
                     ...
                     <?php if(isset($user->data->role) && ($user->data->role === 'S-ACAD' || $user->data->role === 'ADMIN')) { ?>
                        <button id="update_btn" class="download_btn bg-primary">
                           <svg
                     ...
                     <?php } ?>
                     <button id="download_btn" class="download_btn d-none" disabled>
                        <svg
                           width="18" height="16" viewBox="0 0 18 16" fill="none"
                           xmlns="http://www.w3.org/2000/svg">
                           <path
