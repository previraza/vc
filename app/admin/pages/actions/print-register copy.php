...
<html class="no-js" lang="zxx">
   <head>
      ...
      <meta http-equiv="x-ua-compatible"
         content="ie=edge">
      <title>FORMULAIRE D'INSCRIPTION ISTA KINSHASA - <?= $f->id ?> - <?="$f->nom $f->postnom"?></title>
      <meta name="author" content="Mci Mangala">
      <meta
         name="description" content="ISTA - Kinshasa">
      <meta
         name="keywords" content="ISTA - Kinshasa">
      <meta
                     ...
                     <table class="invoice-table table-style8">
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><?=$f->numero_bordereau?></td>
                           </tr>
                           <tr>
                              <th>Etat-civil :</th>
                              <td><?=['C'=>"Celibataire", 'M'=>"Marie(e)", 'D'=>"Divorse(e)", 'A'=>"Autre"][$f->etat_civil]??"Undefined"?> </td>
                              <th>Genre:</th>
                              <td><?=['M'=>"Masculin", 'F'=>"Feminin", 'A'=>"Autre"][$f->sexe]??"Undefined"?></td>
                           </tr>
                           <tr>
