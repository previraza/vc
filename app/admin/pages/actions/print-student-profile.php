<?php 
   ...
   $fc = $db_poo->query("SELECT * FROM students_ WHERE id = ".(is_numeric($_GET['id'])?$_GET['id']:0)) or die($db_poo->error);
   $fac = $fc->fetch_object();
   if (!empty($fac)){ $f = $fac;
?>
<!doctype html>
<html class="no-js" lang="zxx">
   <head>
      ...
      <meta http-equiv="x-ua-compatible"
         content="ie=edge">
      <title>FACTURE ISTA KINSHASA - <?= $f->id ?> - <?="$f->name $f->firstname $f->lastname"?></title>
            ...
            <main>
               <div class="as-invoice invoice_style15">
                  <div class="download-inner" id="download_section">
                           ...
                           <div class="col-auto">
                              <div class="header-logo">
                                <a href="/">
                                  ...
                                  <br>
                                  <span class=text-left><b>Etudiant No : </b>#<?= $f->id ?></span>
                     ...
                     <div class="row justify-content-between my-4">
                        ...
                        <div class="col-auto">
                           <div class="invoice-right">
                              <b><?="$f->name $f->firstname $f->lastname"?></b>
                              <address><?=$f->address?>, <br><?=$f->phone?><br>info@ISTA.ac.cd</address>
                           </div>
                        </div>
                     </div>
                     <hr class="style1">
                     ...
                     <table class="invoice-table table-style8">
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><?=$f->lastname?></td>
                              <th>Genre:</th>
                              <td><?=['M'=>"Masculin", 'F'=>"Feminin", 'A'=>"Autre"][$f->gender]??"Undefined"?></td>
                           </tr>
                           <tr>
                              <th>La religion :</th>
                              <td><?=['C'=>"Chretien", 'H'=>"Hislamiste", 'A'=>"Autre"][$f->religion]??"Undefined"?> </td>
                     ...
                     <p class="company-address style2"><b>ISTA:</b>3930 Aérodrome, Kinshasa, Barumbu, Ndolo</p>
