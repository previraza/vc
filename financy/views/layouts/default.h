    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <?= Session::init()->get('DATA::MENU')->home?>    
                <li>
                    <hr class="hr-horizontal">
                </li>
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled text-start" href="#" tabindex="-1">
                        <span class="default-icon" data-bs-toggle="tooltip" title="Attribution">Attribution</span>
                        <span class="mini-icon">-</span>
                    </a>
                </li>
                <?= Session::init()->get('DATA::MENU')->attribution?>    
                <li>
                    <hr class="hr-horizontal">
                </li>
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled text-start" href="#" tabindex="-1">
                        ...
                        <span class="mini-icon" data-bs-toggle="tooltip" title="Configuration"
                            data-bs-placement="right">-</span>
                    </a>
                </li>
                <?= Session::init()->get('DATA::MENU')->configuration?>    
            </ul>
            <!-- Sidebar Menu End -->
        </div>
    </div>
                                            ...
                                            <ul aria-expanded="false"
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul aria-expanded="false"
                                                        ...
                                                        id="defaultAuth">
                                                        <li class="nav-item"><a class="nav-link "
                                                                href="<?=root('authentification/logout')?>">Sign In</a></li>
                                                        <li class="nav-item"><a class="nav-link "
                    ...
                    <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                        ...
                        <li class="nav-item dropdown" id="itemdropdown1">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                <li>
                                    <a class="dropdown-item" href="<?=root('authentification/logout')?>">Logout</a>
                                </li>
                            </ul>
                        </li>
