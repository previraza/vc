<aside class="sidebar sidebar-base " id="first-tour" data-toggle="main-sidebar" data-sidebar="responsive">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="/financy" class="navbar-brand">
            ...
            <!--logo End-->
            <h4 class="logo-title" data-setting="app_name"><?= app()->name ?></h4>
        </a>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/financy">
                    ...
                    <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="index-boxed-fancy.html">
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Boxed Fancy"
                                    data-bs-placement="right">
                                    B </i>
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../index.html" target="_blank">
                    ...
                    <ul class="sub-nav collapse" id="e-commerce" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="../e-commerce/vendor-dashboard.html">
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Wishlist"
                                    data-bs-placement="right"> VD
                                </i>
                                <span class="item-name">Vendor Dashboard</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#shop-main" role="button"
                                aria-expanded="false" aria-controls="shop-main">
                                <i class="icon">
                                    <svg width="20" class="icon-20" height="20" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4"
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Shop"
                                    data-bs-placement="right">
                                    SP
                                </i>
                            ...
                            <ul class="sub-nav collapse" id="shop-main" data-bs-parent="#e-commerce">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="../e-commerce/shop-right-filter.html">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip"
                                            title="Shop - Right Filter" data-bs-placement="right"> SR </i>
                                        <span class="item-name">Shop - Right Filter</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link product-grid" aria-current="page"
                                        href="../e-commerce/products3632.html?type=product-grid">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link product-list" aria-current="page"
                                        href="../e-commerce/products1936.html?type=product-list">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <g>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="../e-commerce/invoice.html">
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Invoice"
                    ...
                    <ul class="sub-nav collapse" id="social" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="../social-app/newsfeed.html">
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Newsfeed"
                                    data-bs-placement="right"> N
                                </i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#friends" role="button"
                                aria-expanded="false" aria-controls="friends">
                                <i class="icon">
                                    <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Friends"
                                    data-bs-placement="right"> F
                                </i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#profile" role="button"
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Profile"
                                    data-bs-placement="right"> P
                                </i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#event" role="button"
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Events"
                                    data-bs-placement="right"> E
                                </i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#group" role="button"
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Groups"
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="blog" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" data-bs-toggle="collapse" href="#blog1" role="button"
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Blog"
                                    data-bs-placement="right"> B </i>
                                <span class="item-name">Blog</span>
                                <i class="right-icon">
                                    <svg class="submit icon-18" xmlns="http://www.w3.org/2000/svg" width="18"
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#appointment" role="button"
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#file-manager" role="button"
                        aria-expanded="false" aria-controls="sidebar-special">
                    ...
                    <ul class="sub-nav collapse" id="file-manager" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="../file-manager/image-folder.html">
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Images"
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="../file-manager/video-folder.html">
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Videos"
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="../file-manager/trash.html">
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Trash"
                    ...
                    <ul class="sub-nav collapse" id="mail" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link " href="../mail/index.html">
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Mail"
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth1" role="button"
                                aria-expanded="false" aria-controls="sidebar-user">
                            ...
                            <ul class="sub-nav collapse" id="sidebar-auth1" data-bs-parent="#sidebar-auth">
                                <li class="nav-item">
                                    <a class="nav-link" href="authentification/logout">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <g>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth2" role="button"
                                aria-expanded="false" aria-controls="sidebar-user">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth3" role="button"
                                aria-expanded="false" aria-controls="sidebar-user">
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Popup"
                                    data-bs-placement="right">PP</i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth4" role="button"
                                aria-expanded="false" aria-controls="sidebar-user">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-table" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="table/fixed-table.html">
                                ...
                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Fixed Table"
                                    data-bs-placement="right">
                                    FT </i>
...
<main class="main-content">
        ...
        <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar header-hover-menu left-border">
            <div class="container-fluid navbar-inner">
                <a href="/financy" class="navbar-brand">
                    ...
                    <!--logo End-->
                    <h4 class="logo-title d-block d-xl-none" data-setting="app_name"><?= app()->name ?></h4>
                </a>
                <div class="sidebar-toggle" data-toggle="sidebar" data-active="true">
                    <i class="icon d-flex">
                ...
                <div class="d-flex align-items-center justify-content-between product-offcanvas">
                    ...
                    <div class="offcanvas offcanvas-end shadow-none iq-product-menu-responsive" tabindex="-1"
                        ...
                        <div class="offcanvas-body">
                            <ul class="iq-nav-menu list-unstyled d-none">
                                <li class="nav-item active">
                                    ...
                                    <ul class="iq-header-sub-menu list-unstyled collapse" id="homeData">
                                        ...
                                        <li class="nav-item"><a class="nav-link " href="../social-app/index.html">Social
                                                App</a></li>
                                        <li class="nav-item"><a class="nav-link " href="../blog/index.html">Blog</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="../appointment/index.html">Appointment</a></li>
                                        <li class="nav-item"><a class="nav-link " href="../file-manager/index.html">File
                                                Manager</a></li>
                                        <li class="nav-item"><a class="nav-link " href="../chat/index.html"
                                                target="_blank">Chat</a></li>
                                        <li class="nav-item"><a class="nav-link " href="../mail/index.html">Mail</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                            ...
                                            <ul aria-expanded="false"
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul aria-expanded="false"
                                                        ...
                                                        id="defaultAuth">
                                                        <li class="nav-item"><a class="nav-link "
                                                                href="authentification/logout">Sign In</a></li>
                                                        <li class="nav-item"><a class="nav-link "
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul aria-expanded="false"
                                                        ...
                                                        <li class="nav-item"><a class="nav-link "
                                                                href="auth-pro/reset-password.html">Reset password</a>
                                                        </li>
                                                        <li class="nav-item"><a class="nav-link "
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="iq-header-sub-menu list-unstyled collapse" id="elementsData">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul aria-expanded="false"
                                                class="iq-header-sub-menu left list-unstyled collapse" id="widgetsPage">
                                                <li class="nav-item"><a class="nav-link "
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul aria-expanded="false"
                                                class="iq-header-sub-menu left list-unstyled collapse" id="formsPages">
                                                <li class="nav-item"><a class="nav-link "
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul aria-expanded="false"
                                                class="iq-header-sub-menu left list-unstyled collapse" id="tablesPages">
                                                <li class="nav-item"><a class="nav-link "
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul aria-expanded="false"
                                                class="iq-header-sub-menu left list-unstyled collapse" id="iconsPages">
                                                <li class="nav-item"><a class="nav-link "
                    ...
                    <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                        ...
                        <li class="nav-item dropdown" id="itemdropdown1">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                <li>
                                    <a class="dropdown-item" href="app/user-privacy-setting.html">paramètres du compte</a>
                                </li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li>
                                    <a class="dropdown-item" href="authentification/logout">Déconnection</a>
                                </li>
                            </ul>
                        </li>
    ...
    <a class="btn btn-fixed-end btn-warning btn-icon btn d-none d-none-setting" id="settingbutton" data-bs-toggle="offcanvas"
