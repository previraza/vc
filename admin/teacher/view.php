<?php session_start(); isset($_SESSION['ADMIN']) ? null : header('Location:../login'); require_once '../../app/settings/params/connect'; require_once "../../public/_header.php";
$db_name = db['name'];if (isset($_GET['profile']) && is_numeric($_GET['profile']) && $r = mysqli_fetch_object(mysqli_query($db, "SELECT CONCAT(teachers.firstname, ' ', teachers.lastname) AS name, teachers.* FROM teachers WHERE teachers.delete = 0 AND teachers.id = ".$_GET['profile']))) { ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="ft-team-personal-cta text-center" data-background="/public/assets/img/bg/td-bg.webp">
                        <div class="ft-team-personal-cta-icon d-flex justify-content-center align-items-center"> <i
                                class="fal fa-phone-rotary"></i> </div>
                        <div class="ft-team-personal-cta-text headline">
                            <h3>Contact Info :</h3> <span>Phone : (+243) 987 654 321</span> <span>Email :
                                Contact@email.com</span>
                        </div>
                    </div>
                </div>
            </div>
