<?php 
   ...
   $fc = $db_poo->query("SELECT payments.*, register.telephone, register.sexe, CONCAT(agents.firstname, ' ', agents.lastname) AS agent, CONCAT(register.nom, ' ', register.postnom) AS std 
       FROM payments JOIN agents ON payments.user_id = agents.user_id LEFT JOIN register ON register.id = payments.student  WHERE payments.id = $_GET[id]") or die($db_poo->error);
   $fac = $fc->fetch_object();
   if (!empty($fac)){ $f = $fac;
...
<html class="no-js" lang="zxx">
   <head>
      ...
      <meta http-equiv="x-ua-compatible"
         content="ie=edge">
      <title>FACTURE INBTP KINSHASA NGALIEMA - <?= $f->student ?> - <?=$f->std?$f->std:$f->student_name?></title>
   ...
   <body>
      <div
         ...
         <div class="invoice-container">
            <main>
               <div
                  class="as-invoice invoice_style2">
                  <div
                     class="download-inner" id="download_section">
                     <header
                        class="as-header header-layout1">
                        <div class="row
                     ...
                     <div
                        ...
                        <div
                           ...
                           <div class="booking-info">
                              <p><b>Institut National du Bâtiment et des Travaux Publics - INBTP Kinshasa
                                 </b>
                              </p>
                              <p><b>Mode de Payement :
                                 </b>
                     ...
                     <div
                        ...
                        <div class="col-6">
                           <div
                              class="address-box address-left">
                              <b>Vos
                              Informations :</b>
                              <address><?=$f->std?$f->std:$f->student_name?><br>Phone: <?=$f->telephone?><br>Sexe:
                                 <?= ["_"=>"","A"=>"Autre","F"=>"Féminin","M"=>"Masculin"][$f->sexe?$f->sexe:'_']?><br>
                              </address>
                           </div>
                        </div>
                        <div
                           ...
                           <div class="address-box
                              address-right">
                              <b>Details Agences:</b>
                              <address>Vira-Bank<br>Guichet No. 1<br>Kinshasa-Ngaliema,
                                 R.D.Congo.
                              </address>
                           </div>
                        </div>
                     ...
                     <div
                        ...
                        <div
                           ...
                           <div class="invoice-left">
                              <b>Please
                              Note:</b>
                              <p class="mb-0">Le montant payé ne peut etre ni repris, ni transférer à un tiers.</p>
                           </div>
                        </div>
                        <div
                           class="col-auto">
                     ...
                     <p
                        class="company-address"><b>Invce Inc:</b><br>21, Av. de la Montagne, Q. Joli-Parc, Kinshasa-Ngaliema, République Démocratique du Congo</p>
                     <p
                        class="invoice-note mt-3 text-center">
                        <svg
                        ...
                        <b>NOTE: </b>La facture ci-dessus a été générée par l'ordinateur
                        réception et ne nécessite pas de Signature.
                     </p>
                  </div>
                  <div
