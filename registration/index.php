<?php
    header('location:/registration/licence.php');
?>
    ...
    <div class="container d-block">
        <div class="ft-blog-top-content d-flex justify-content-between align-items-end flex-wrap">
            <div class="ft-section-title pera-content w-100 mw-100">
               ...
               <marquee><h3 class="text-primary">Les inscriptions pour l'année académique 2024-2025 seront effectives ce mardi 24/09/2024 à 08h00. </h3></marquee>
                            ...
                            <section>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="list">
                                        ...
                                        <label for="c1">
                                            <div class="title">
                                                <a href="https://www.ista.ac.cd/registration/licence.php">Premier Cycle</a>
                                            </div>
                                        </label>
                                        </div>
                                        <div class="form-element">
                                        <input type="radio" name="cycle" value="c2" id="c2" disabled>
                                        <label for="c2">
                                            <div class="title">
                                                <a href="https://www.ista.ac.cd/registration/master.php">Master</a>
                                            </div>
                                        </label>
                                        </div>
                                        <div class="form-element">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="list">
                                        ...
                                        <div class="form-element" style="display: none;">
                                            <input type="radio" name=orientation_ class="orientation c1" value="c1-btp" id="c1-prepa" checked>
                                            <label for="c1-prepa">
                                                <div class="title">
                                    ...
                                    <div class="form-row mt-3">
                                        <div class="description">
                                            ...
                                            <ol class="m-0 ml--30">
                                                ...
                                                <li>Certificat de bonne conduite, vie et moeurs.</li>
