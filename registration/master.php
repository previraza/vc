                        ...
                        <form class="form-register" id="form-register" action="#" method="post">
                                ...
                                <div class="inner inner-2">
                                    <div id="content-form-wrapper">
                                        <div class="row">
                                            ...
                                            <div class="form-heading col-12">
                                                <h3 class=pb-3>Etudes de Graduat</h3>
                                                <span>7/10</span>
                                            </div>
                                            ...
                                            <div class="col-12 form-group">
                                                <label>Etudes post-de Graduat</label>
                            ...
                            <section>
                                    ...
                                    <div class="form-holder form-holder-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="contact-information col-xl-12 col-lg-6 col-12 mt-3">
                                                <h3>Etudes de Graduat faites</h3>
                                                <table class=w-100>
                                                    <tbody>
                                                        <tr>
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="text" placeholder="#0xx0000000000000000" ng-model=numero_bordereau name=registers[numero_bordereau] class="form-control" value=0>
